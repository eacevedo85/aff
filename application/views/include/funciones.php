...
$( document ).ready(function() {
	$( '#es_campana' ).click(function(){
		if( this.checked ){
			$( "#campana" ).removeClass('hide');	
		}else{
			$( "#campana" ).addClass('hide');
		}
   	$( "#campana" ).toggle( this.checked );
	});
...
function suma(){
	if( $( '#folio_inicial' ).val() != "" && $( '#folio_final' ).val() != "" ){
		var suma = parseInt( $( '#folio_final' ).val() ) - parseInt( $( '#folio_inicial' ).val() ) + 1 ;
		$( '.asignados' ).html( suma );
	}
